...
/**
 * Implementation of sample-tab configuration page
 */
export const SampleTabConfig = () => {
    ...
    const onSaveHandler = (saveEvent: pages.config.SaveEvent) => {
        ...
        pages.config.setConfig({
            contentUrl: host + "/sampleTab/?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}",
            websiteUrl: host + "/sampleTab/?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}",
            suggestedDisplayName: "sample-tab",
            removeUrl: host + "/sampleTab/remove.html?theme={theme}",
